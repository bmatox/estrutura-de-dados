...
//(PD) Desenvolva uma operação para transferir elementos de uma pilha P1 para uma pilha P2 ˜(copia).
public class Q6 {
    ...
    public boolean pilhaMaior(Q6 P2) {
    ...
    public void copiaPilha(Q6 P2) {
        Q6 Q = new Q6(); //cria uma pilha auxiliar Q do mesmo tamanho que P1
        while(!this.isEmpty()){ //enquanto P1 não estiver vazia
            int x = this.pop(); //desempilha um elemento de P1 e armazena em x
            Q.push(x); //empilha x em Q
        }
        while(!Q.isEmpty()){ //enquanto Q não estiver vazia
            int x = Q.pop(); //desempilha um elemento de Q e armazena em x
            this.push(x); //empilha x em P1
            P2.push(x); //empilha x em P2
        }
    }

    public static void main(String[] args) {
        Q6 P1 = new Q6(); //cria uma pilha P1
        Q6 P2 = new Q6(); //cria uma pilha P2
        ...
        P1.imprimePilha(); //imprime a pilha original

        System.out.println("\nPilha cópia:");
        P1.copiaPilha(P2); //chama o método copiaPilha() passando P2 como parâmetro
        P2.imprimePilha(); //imprime a pilha cópia
    }
